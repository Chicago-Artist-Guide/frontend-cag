  ...
  about: [
    ...
    },
    {
      ...
      answer: [
        ...
        ' - Chicagoland theatre practitioners are invited to join our Artist Board. You will have the opportunity to provide feedback on the platform and host events for the community. Please apply here, if interested.',
        <br />,
        <br />,
        <b>Volunteer Staff</b>,
