...
import Morris from '../../images/who-we-are/board/Staff_Morris.jpg';
import Morton from '../../images/who-we-are/board/Staff_Morton.jpg';
...
>>>>>>> d2e75e8 (Update bios)
    ...
    },
    {
      ...
      role: 'Board Member',
      pronouns: 'he/him',
      affiliation: 'Vice President Of Product Development, First Look',
      image: Zacks,
...
>>>>>>> d2e75e8 (Update bios)
      ...
      pronouns: 'she/her',
      affiliation:
        'Director of Artistic Development, Kansas City Repertory Theatre',
      image: Gordon,
...
<<<<<<< HEAD
      ...
      pronouns: 'she/her',
      affiliation:
        'Director Content Strategy and Marketing, Medical Library Association',
      image: Birkner,
...
<<<<<<< HEAD
      ...
      affilitation: null,
      image: Morton,
      linkedin: 'kate-morton-2a0861128',
      bio:
        "graduated from the University of San Diego with a B.A in Theatre Arts and Performance Studies. While at USD, Kate appeared as the title characters in both LYSISTRATA and HENRY V. She also directed THE NINA VARIATIONS by Steven Dietz and worked as an assistant stage manager, stage manager, run crew, and dresser during her time at USD. After university, Kate participated in a year-long apprenticeship at Capital Stage in Sacramento. While there she gained experience in set construction, run crew, assistant stage managing, assistant directing, and house management. Her apprenticeship culminated in the Capital Stage Apprentice Compan's NIGHT OF SCENES which she co-directed, co-produced, and acted in. After completing her apprenticeship she went on to house manage for Capital Stage, and made her professional acting debut there as Cassie in THE WICKHAMS: CHRISTMAS AT PEMBERLEY. She is currently the Venue Experience Manager at the San Diego Repertory Theatre. Kate is passionate about all things Shakespeare, Chekhov, and shadow puppets. One day, Kate would like to open her own theatre company with the goal of increasing diversity and accessibility in the American Theatre."
=======
      id: 34,
      name: 'Jordin Jewell',
      role: 'Marketing Director',
...
>>>>>>> d2e75e8 (Update bios)
    ...
    },
    {
      ...
      bio:
        'is an actor/writer/director from Springfield, MO. After earning a BFA in Acting from Missouri State University, James moved to Chicago where he has been actively writing and performing throughout the city and beyond. Continuing his training, he completed the improv program at iO, as well as the Comedy Writing Program and the Conservatory at Second City. His pursuit of sketch comedy has allowed him to perform in venues and festivals throughout the country, including a guest performance on an award-winning talk show.  Recently, James completed the Actualize Coding Bootcamp and immediately joined CAG, and he cannot wait to share the project with his fellow performers.'
<<<<<<< HEAD
    },
    {
      id: 28,
