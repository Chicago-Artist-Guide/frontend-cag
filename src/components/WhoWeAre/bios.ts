...
const bios = {
  ...
  technical: [
    ...
    },
    {
      ...
      bio:
        'Developer is an actor/writer/director from Springfield, MO. After earning a BFA in Acting from Missouri State University, James moved to Chicago where he has been actively writing and performing throughout the city and beyond. Continuing his training, he completed the improv program at iO, as well as the Comedy Writing Program and the Conservatory at Second City. His pursuit of sketch comedy has allowed him to perform in venues and festivals throughout the country, including a guest performance on an award-winning talk show.  Recently, James completed the Actualize Coding Bootcamp and immediately joined CAG, and he cannot wait to share the project with his fellow performers.'
    }
  ]
};
