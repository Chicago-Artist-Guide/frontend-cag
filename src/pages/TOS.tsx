...
const TOS = () => (
  <Container className="margin-container">
    ...
    <p>
      ...
      that changes cannot be retroactive. If you object to any changes, you may
      close your account. Your continued use of our Services after we publish or
      send a notice about our changes to these terms means that you are
    ...
    <p>
      ...
      including accounts registered on behalf of others or persons under the age
      of 16.
    </p>
    <p>
    ...
    <p>
      As between you and others (including your employer), your account belongs
      to you. However, if the Services were purchased by another party for you
      to use (e.g. Recruiter seat bought by your employer), the party paying for
      such Service has the right to control access to and get reports on your
    ...
    <p>
      Our Services allow messaging and sharing of information in many ways, such
      as your profile, articles, group posts, links to news articles, job
      postings, and messages. Information and content that you share or post may
      ...
      content to your addressees, sharing content only to CAG connections,
      restricting your profile visibility from search engines, or opting not to
      notify others of your CAG profile update). For job searching activities,
      we default to not notifying your connections network or the public. So, if
      you apply for a job through our Service or opt to signal that you are
      interested in a job, our default is to share it only with the job poster.
    </p>
    <p>
    ...
    <p>
      As between you and CAG, you own the content and information that you
      submit or post to the Services, and you are only granting CAG and our
    ...
    <ul>
      <li>
        <p>
          ...
          you provide through our Services and the services of others, without
      ...
      <ul>
        <li>
          <p>
            ...
            reasonable time it takes to remove from backup and other system.
          </p>
        </li>
        <li>
          <p>
            We will not include your content in advertisements for the products
            and services of third parties to others without your separate
            consent (including sponsored content). However, we have the right,
            without payment to you or others, to serve ads near your content and
            ...
            feature, we may mention that with your name or photo to promote that
            feature within our Services, subject to your settings.
          </p>
        </li>
        <li>
          <p>
            ...
            other Members to embed that public post onto third-party services,
            and we enable search engines to make that public content findable
        ...
        <li>
          <p>
            ...
            others, including under the terms of a Creative Commons license.
          </p>
        </li>
        <li>
          <p>
            You and CAG agree that if content includes personal data, it is
    ...
    <p>
      You and CAG agree that we may access, store, process and use any
    ...
    <p>
      By submitting suggestions or other feedback regarding our Services to CAG,
      you agree that CAG can use and share (but does not have to) such feedback
      for any purpose without compensation to you.
    </p>
    <p>
      You promise to only provide information and content that you have the
      right to share, and that your CAG profile will be truthful.
    </p>
    <p>
    ...
    <p>
      CAG may help connect Members offering their services (career coaching,
      accounting, etc.) with Members seeking services. CAG does not perform nor
      employs individuals to perform these services. You must be at least 18
    ...
    <p>
      Similarly, CAG may help you register for and/or attend events organized by
      Members and connect with other Members who are attendees at such events.
      You agree that (1) CAG is not responsible for the conduct of any of the
      Members or other attendees at such events, (2) CAG does not endorse any
      particular event listed on our Services, (3) CAG does not review and/or
    ...
    <p>
      ...
      trademarks of their respective owners. Chicago Artist Guide, service
    ...
    <p>
      ...
      CONTRACT), CHICAGO ARTIST GUIDE, INCLUDING ITS AFFILIATES, WILL NOT BE
      LIABLE IN CONNECTION WITH THIS CONTRACT FOR LOST PROFITS OR LOST BUSINESS
      OPPORTUNITIES, REPUTATION (E.G., OFFENSIVE OR DEFAMATORY STATEMENTS), LOSS
      OF DATA (E.G., DOWN TIME OR LOSS, USE OF, OR CHANGES TO, YOUR INFORMATION
      OR CONTENT) OR ANY INDIRECT, INCIDENTAL, CONSEQUENTIAL, SPECIAL OR
      PUNITIVE DAMAGES.
    </p>
    <p>
      CHICAGO ARTIST GUIDE AND ITS AFFILIATES WILL NOT BE LIABLE TO YOU IN
      CONNECTION WITH THIS CONTRACT FOR ANY AMOUNT THAT EXCEEDS (A) THE TOTAL
    ...
    <p>
      ...
      personal injury or for fraud, gross negligence or intentional misconduct,
      or in cases of negligence where a material obligation has been breached, a
      material obligation being such which forms a prerequisite to our delivery
      of services and on which you may reasonably rely, but only to the extent
      that the damages were directly caused by the breach and were foreseeable
      upon conclusion of this Contract and to the extent that they are typical
    ...
    <p>
      In the unlikely event we end up in a legal dispute, you and Chicago Artist
    ...
    <p>
      ...
      make that part enforceable while still achieving its intent. If the court
      cannot do that, you and we agree to ask the court to remove that
      unenforceable part and still enforce the rest of this Contract.
    </p>
    <p>
      This Contract (including additional terms that may be provided by us when
      you engage with a feature of the Services) is the only agreement between
    ...
    <p>
      ...
      that CAG has waived its right to enforce this Contract. You may not assign
      or transfer this Contract (or your membership or use of Services) to
      anyone without our consent. However, you agree that CAG may assign this
